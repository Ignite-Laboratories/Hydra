...
func CreateWindow(engine *core.Engine, title string, size *std.XY[int], pos *std.XY[int], impulsable core.Impulsable, potential core.Potential, muted bool) *hydra.Head[*sdl.Window, sdl.GLContext, sdl.Event] {
	Activate()
	...
	w := &Window{}
	w.Head = &hydra.Head[*sdl.Window, sdl.GLContext, sdl.Event]{}
...
func CreateFullscreenWindow(engine *core.Engine, title string, impulsable core.Impulsable, potential core.Potential, muted bool) *hydra.Head[*sdl.Window, sdl.GLContext, sdl.Event] {
	Activate()
